#!/usr/bin/env bash
# pack.sh — Create a clean zip of FxFixParser for deployment.
# Usage: ./pack.sh [output_name]
#   output_name: optional zip filename (default: FxFixParser_YYYYMMDD_HHMMSS.zip)
#
...
FILENAME="${1:-FxFixParser_${TIMESTAMP}.zip}"
